...
http://www.cs.yale.edu/homes/aspnes/pinewiki/BTrees.html
https://stackoverflow.com/questions/36829399/want-to-print-out-a-pretty-btree/36848138#36848138
...
typedef struct btNode *bTree;    /* implementation of a B-tree */
bTree btCreate(void);            /* create a new empty tree */
void btDestroy(bTree t);         /* free a tree */
int btSearch(bTree t, int key);  /* return nonzero if key is present in tree */
void btInsert(bTree t, int key); /* insert a new element into a tree */
void btPrintKeys(bTree t);       /* print all keys of the tree in order */
