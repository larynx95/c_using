...
void heapify(minHeap *hp, int i) {
  int smallest =
      (LCHILD(i) < hp->size && hp->elem[LCHILD(i)].data < hp->elem[i].data)
          ? LCHILD(i)
          : i;
  if (RCHILD(i) < hp->size &&
      hp->elem[RCHILD(i)].data < hp->elem[smallest].data) {
    smallest = RCHILD(i);
  }
  if (smallest != i) {
...
/*
    Function to display all the nodes in the min heap by doing a inorder
   traversal
*/
...
/*
    Function to display all the nodes in the min heap by doing a preorder
   traversal
*/
...
/*
    Function to display all the nodes in the min heap by doing a post order
   traversal
*/
...
/*
    Function to display all the nodes in the min heap by doing a level order
   traversal
*/
