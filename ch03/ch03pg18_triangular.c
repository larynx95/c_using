...
Write a function int isUpperTriangular (int a[][], int n)
that returns 1 if the matrix is upper triangular.
(Hint: Array A is upper triangular if A ij = 0 and i>j )

# Concepts: upper and lower triangular matrices
******************************************************************************/
